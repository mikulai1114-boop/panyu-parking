...
git add 主程式\import.py 主程式\catch_up.py 主程式\run_daily.bat 主程式\安裝說明.md 每日現金支付統計\import.py 每日現金支付統計\匯入停車資料.py 每日現金支付統計\每日匯入.bat .gitignore >> C:\temp\parking\run_log.txt 2>&1
